                        ...
                        <div>
                            <form method="POST" action="{{ route('registerAdmin.store') }}" id="registrasiForm">
                                ...
                                <div class="form-group mt-3">
                                    ...
                                    <div class="">
                                        <input id="nama_lengkap" class="form-control @error('nama_lengkap') is-invalid @enderror" name="nama_lengkap" value="{{ old('nama_lengkap') }}" required autocomplete="nama_lengkap" autofocus>
                                        @error('nama_lengkap')
                                        <span class="invalid-feedback">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group mt-3">
                                    ...
                                    <div class="">
                                        <input id="alamat" class="form-control @error('alamat') is-invalid @enderror" name="alamat" value="{{ old('alamat') }}" required autocomplete="alamat" autofocus>
                                        @error('alamat')
                                        <span class="invalid-feedback">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                {{-- ROLE --}}
                                <div class="form-group mt-3">
                                    <label for="role" class="text-md-right">{{ __('Role   ') }}</label>
                                    <div class="">
                                        <select name="user_type" id="role" class="form-control">
